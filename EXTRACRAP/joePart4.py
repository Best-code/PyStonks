...
def sellTrailingStop(day,sell_limit):
    while aaplDf['Close'][day] >=1.15* sell_limit:
...
######### CRITERIA to initiate sell ticket
for day in range(len(aaplDf)):
